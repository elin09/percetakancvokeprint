    ...
    <div class="col-lg-8">
     <form method="post" action="" class="mb-5" enctype="multipart/form-data">
      ...
      <div class="mb-3">
       ...
       <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="<?= $produk["nama_produk"]; ?>" required autofocus">

      </div>

      <div class="mb-3">
       <label for="harga_produk" class="form-label">Harga</label>
       <input type="number" class="form-control " id="harga_produk" value="<?= $produk["harga_produk"]; ?>" name="harga_produk" required">
      </div>
      <div class="mb-3">
       <label for="jumlah_produk" class="form-label">Jumlah</label>
       <input type="number" class="form-control " id="jumlah_produk" value="<?= $produk["jumlah_produk"]; ?>" name="jumlah_produk" required">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
       ...
       <input id="body" type="hidden" value="<?= $produk["deskripsi"]; ?>" name="deskripsi">
       <trix-editor input="body" value="<?= $produk["deskripsi"]; ?>"></trix-editor>
      </div>
