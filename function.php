...
function cari_produk($keyword){
    ...
    function tambah_transaksi($data){
        ...
        $insert = "INSERT INTO `transaksi` (`id_transaksi`, `id_admin`, `id_customer`, `id_produk`, `jumlah_pesanan`, `tanggal_transaksi`) VALUES  
        (NULL,'$nama_admin', '$nama_customer', '$nama_produk', '$jumlah_pesanan', current_timestamp());";
